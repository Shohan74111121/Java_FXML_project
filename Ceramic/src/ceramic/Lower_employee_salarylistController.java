 ...
 * @author Shohan
 */
public class Lower_employee_salarylistController implements Initializable {
    ...
    private Button download_salary_pdf;
    ...
    public ObservableList<salary_emp> getemployee(){
        ...
        semployee.add(new salary_emp("0001", "Noob", 5000,"HR"));
        semployee.add(new salary_emp("0003", "Shawkot", 5000,"Accounts"));
        semployee.add(new salary_emp("0005", "Nafis", 68164,"Production"));
        semployee.add(new salary_emp("005", "asdsa",85645, "Accounts"));
        semployee.add(new salary_emp("0053", "Duoch", 5684,"Accounts"));
        semployee.add(new salary_emp("0085", "Nafis", 5681,"Production"));
        return semployee;
    }
...
//        pass selected row to detailed person view scene
    ...
    private void detailedsalary_empView(ActionEvent event) throws IOException {
        ...
        loader.setLocation(getClass().getResource("detailed_emp_info.fxml"));
        ...
        Detailed_emp_infoController controller = loader.getController();
